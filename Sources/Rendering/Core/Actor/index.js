...
function newInstance(initialValues = {}) {
  const model = Object.assign({}, Prop.DEFAULT_VALUES, Prop3D.DEFAULT_VALUES, DEFAULT_VALUES, initialValues);
  const publicAPI = {};
  ...
  // Inheritance
  Prop.prop(publicAPI, model);
  Prop3D.prop3D(publicAPI, model);

  model.matrix = mat4.create(); // from Prop3D
...
export default { newInstance, DEFAULT_VALUES, actor };
